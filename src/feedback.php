...
Имя: <span style="font-weight:bold;color:#000;">'.$_POST['name-feedback'].'</br>
Телефон: <span style="font-weight:bold;color:#000;">'.$_POST['email-feedback'].'</br>
Комментарий: <span style="font-weight:bold;color:#000;">'.$_POST['comment-feedback'];
